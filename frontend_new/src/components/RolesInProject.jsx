		...
		<MDBDropdown style={{ marginLeft: '0.5rem' }}>
			...
			<MDBDropdownMenu>
				<div style={{ display: 'flex', alignItems: 'center', padding: '0.5rem', paddingBottom: '0' }}>
					<input type='checkbox' name='MEMBER' id='MEMBER' checked={selectedRoles.MEMBER} onChange={handleCheckboxChange} style={{ height: '1rem', width: '1rem', marginRight: '0.5rem', borderRadius: '4px' }} />
					<label htmlFor='MEMBER'>Участник</label>
				</div>
				<div style={{ display: 'flex', alignItems: 'center', padding: '0.5rem', paddingBottom: '0' }}>
					<input type='checkbox' name='ADMIN' id='ADMIN' checked={selectedRoles.ADMIN} onChange={handleCheckboxChange} style={{ height: '1rem', width: '1rem', marginRight: '0.5rem', borderRadius: '4px' }} />
					<label htmlFor='ADMIN'>Администратор</label>
				</div>
				<div style={{ display: 'flex', alignItems: 'center', padding: '0.5rem' }}>
					<input type='checkbox' name='VIEWER' id='VIEWER' checked={selectedRoles.VIEWER} onChange={handleCheckboxChange} style={{ height: '1rem', width: '1rem', marginRight: '0.5rem', borderRadius: '4px' }} />
